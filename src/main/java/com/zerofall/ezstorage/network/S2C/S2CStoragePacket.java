 ...
 */
public class S2CStoragePacket implements EmiPacket {

    public static final ResourceLocation CHANNEL = new ResourceLocation(EZStorageAddon.MOD_ID, "s2c_storage");
    ...
    public S2CStoragePacket(EZInventory inventory)
    {
        ...
        {
            EZStorageAddon.instance.LOG.error("Failed to serialize EZInventory", exception);
        }
    ...
    public void apply(EntityPlayer player)
    {
        ...
        if (player.openContainer instanceof ContainerStorageCore container)
        {
            ...
            {
                EZStorageAddon.instance.LOG.error("Failed to deserialize EZInventory", exception);
            }
        }
    }

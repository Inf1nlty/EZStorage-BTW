 ...
 */
public class S2COpenGuiPacket implements EmiPacket {

    public static final ResourceLocation CHANNEL = new ResourceLocation(EZStorageAddon.MOD_ID, "s2c_open_gui");

...
public class EZConfiguration extends SimpleConfigs {
    ...
    public static final ConfigInteger portableTerminalRange = new ConfigInteger(Reference.MOD_ID + ".portableTerminalRange", 16, 1, 1024, Reference.MOD_ID + ".portableTerminalRange");
    ...
    public static final ConfigInteger guiAutoRefillAmount = new ConfigInteger(Reference.MOD_ID + ".guiAutoRefillAmount", 64, 1, 64, Reference.MOD_ID + ".guiAutoRefillAmount");
    ...
    static {
        ...
        List<ConfigBase<?>> storage = List.of(
            basicCapacity, condensedCapacity, hyperCapacity, maxItemTypes, portableTerminalRange
        );
        List<ConfigBase<?>> gui = List.of(
            focusGuiInput, guiSortMode, guiSortOrder, guiSearchMode, guiSaveSearch, guiAutoRefill, guiAutoRefillAmount, guiSearchText, renderCraftingPreview
        );
